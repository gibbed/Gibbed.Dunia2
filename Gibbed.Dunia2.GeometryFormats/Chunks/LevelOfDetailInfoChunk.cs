...
{
    public class LevelOfDetailInfoChunk : IChunk
    {
        ChunkType IChunk.Type
        {
            get { return ChunkType.LevelOfDetailInfo; }
        }
        ...
        {
            this.Count = input.ReadValueU32(endian);
            this.Unknown1 = input.ReadValueU32(endian);
        }
